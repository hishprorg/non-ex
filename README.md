...
[![npm](https://img.shields.io/npm/v/@hishprorg/non-ex.svg)](https://www.npmjs.com/package/@hishprorg/non-ex)
[![downloads](https://img.shields.io/npm/dt/@hishprorg/non-ex.svg)](https://www.npmjs.com/package/@hishprorg/non-ex)
[![types](https://img.shields.io/npm/types/@hishprorg/non-ex.svg)](https://www.npmjs.com/package/@hishprorg/non-ex)
[![licence](https://img.shields.io/github/license/mnasyrov/@hishprorg/non-ex.svg)](https://github.com/hishprorg/non-ex/blob/master/LICENSE)
[![Coverage Status](https://coveralls.io/repos/github/mnasyrov/@hishprorg/non-ex/badge.svg?branch=main)](https://coveralls.io/github/mnasyrov/@hishprorg/non-ex?branch=main)
...
| --------------------------------------------- | ------------------------------------------ | ---------------------------------------------------------- |
| [**@hishprorg/non-ex**][@hishprorg/non-ex/docs]             | Core elements, state and effect management | [Docs][@hishprorg/non-ex/docs], [API][@hishprorg/non-ex/api]             |
| [**@hishprorg/non-ex-react**][@hishprorg/non-ex-react/docs] | Tooling for React.js                       | [Docs][@hishprorg/non-ex-react/docs], [API][@hishprorg/non-ex-react/api] |
...
```
npm install @hishprorg/non-ex @hishprorg/non-ex-react --save
```
...
import { useConst, useObservable, useQuery } from '@hishprorg/non-ex-react';
...
[@hishprorg/non-ex/docs]: packages/@hishprorg/non-ex/README.md
[@hishprorg/non-ex/api]: packages/@hishprorg/non-ex/docs/README.md
[@hishprorg/non-ex-react/docs]: packages/@hishprorg/non-ex-react/README.md
[@hishprorg/non-ex-react/api]: packages/@hishprorg/non-ex-react/docs/README.md
